...
app.get("/url/emotion", (req,res) => {
    ...
    return res.send(emotions,null,2);
...
app.get("/url/sentiment", (req,res) => {
    ...
    var sentiments = ['positive', 'negative','neutural'];
    var rand = Math.floor(Math.random() * sentiments.length);
    return res.send('{"label" : "' + sentiments[rand] +'"}',null,2);
    /*let urlToAnalyze = req.query.url
        const analyzeParams = 
        {
            "url": urlToAnalyze,
